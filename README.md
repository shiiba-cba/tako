...
tako は 55 mm ボール、PMW3360 光学センサー、RP2040‑Zero MCU、そして 大径 624ZZ による 3 点支持ベアリング構造を採用し、ボタンにはアーケードコントローラー向けのゲームスイッチを用いた 6 ボタン仕様の自作トラックボールです。滑らかな転がりとスムーズな操球感を実現しています。ドラッグスクロール機能に加え、CPI 切り替え機能でポインタ速度を 600 ↔ 200 CPI に即座に変更でき、精密操作のために減速することも可能です。
